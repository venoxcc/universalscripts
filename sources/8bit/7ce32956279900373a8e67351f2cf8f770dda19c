--[[
    Custom Fluent Interface Suite by 8bit
    You can definately use it in your project.
...
local aa = {
    ...
    [11] = function()
        ...
        return function(m, n, o, p)
            ...
            q.TitleLabel =
                ...
                "TextLabel",
                {
                    FontFace = Font.new("rbxassetid://16658237174", Enum.FontWeight.Medium, Enum.FontStyle.Normal),
                    Text = m,
                    TextColor3 = Color3.fromRGB(240, 240, 240),
                    TextSize = 13,
                    TextXAlignment = Enum.TextXAlignment.Left,
    ...
    [16] = function()
        ...
        return function(n)
            ...
            o.Frame =
                l(
                "Frame",
                {Size = UDim2.new(1, 0, 0, 32), BackgroundTransparency = 1, Parent = n.Parent},
                {
                    l(
                        "Frame",
    ...
    [17] = function()
        ...
        return function(t)
            ...
            local D, E =
                ...
                s(
                    "Frame",
                    {
                        Size = UDim2.fromOffset(20, 20),
                        BackgroundTransparency = 1,
                        Position = UDim2.new(1, -1200, 1, -1200)
                    }
                )
            v.TabHolder =
                s(
            ...
            v.Maximize = function(M, N, O)
                v.Maximized = M
                v.TitleBar.MaxButton.Frame.Icon.Size = UDim2.new(0, 60, 0, 60)
                    ...
                    local T, U, V =
                        s(
                            "ImageLabel",
                            {
                                ...
                                Image = "http://www.roblox.com/asset/?id=113537389094073",
                                Parent = S,
    ...
    [27] = function()
        ...
        function c.New(d, e, f)
            ...
            local j, k =
                ...
                ai("UIStroke", {Transparency = 0.1, ThemeTag = {Color = "ToggleSlider"}})
            local l =
                ai(
                "Frame",
                {
            ...
            function h.SetValue(m, n)
                ...
                af:Create(
                    ...
                    {Position = UDim2.new(0, h.Value and 30 or 2, 0.5, 0)}
                ):Play()
                af:Create(
                    l,
                    TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
                ...
                j.ImageTransparency = h.Value and 0 or 0.1
                g:SafeCallback(h.Callback, h.Value)
                g:SafeCallback(h.Changed, h.Value)
            end
            function h.Destroy(m)
    ...
    [47] = function()
        ...
        local af = {Names = {"Darker", "Light", "8bit"}}
    ...
    [49] = function()
        ...
        return {
            Name = "8bit",
            Accent = Color3.fromRGB(75, 85, 115),
            AcrylicMain = Color3.fromRGB(20, 20, 20),
            AcrylicBorder = Color3.fromRGB(50, 60, 100),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(48, 52, 61), Color3.fromRGB(15, 18, 23)),
            AcrylicNoise = 0.92,
            TitleBarLine = Color3.fromRGB(60, 120, 120),
            Tab = Color3.fromRGB(140, 180, 180),
            Element = Color3.fromRGB(110, 118, 160),
            ElementBorder = Color3.fromRGB(40, 52, 70),
            InElementBorder = Color3.fromRGB(80, 92, 110),
            ElementTransparency = 0.84,
            ToggleSlider = Color3.fromRGB(110, 118, 160),
            ToggleToggled = Color3.fromRGB(0, 0, 0),
            SliderRail = Color3.fromRGB(110, 118, 160),
            DropdownFrame = Color3.fromRGB(160, 180, 200),
            DropdownHolder = Color3.fromRGB(40, 53, 80),
            DropdownBorder = Color3.fromRGB(40, 45, 65),
            DropdownOption = Color3.fromRGB(110, 118, 160),
            Keybind = Color3.fromRGB(110, 118, 160),
            Input = Color3.fromRGB(110, 118, 160),
            InputFocused = Color3.fromRGB(20, 10, 30),
            InputIndicator = Color3.fromRGB(130, 145, 170),
            Dialog = Color3.fromRGB(23, 27, 43),
            DialogHolder = Color3.fromRGB(23, 27, 43),
            DialogHolderLine = Color3.fromRGB(31, 38, 59),
            DialogButton = Color3.fromRGB(35, 38, 61),
            DialogButtonBorder = Color3.fromRGB(80, 92, 110),
            DialogBorder = Color3.fromRGB(50, 60, 100),
            DialogInput = Color3.fromRGB(45, 62, 90),
            DialogInputLine = Color3.fromRGB(130, 145, 170),
            Text = Color3.fromRGB(240, 240, 240),
            SubText = Color3.fromRGB(170, 170, 170),
            Hover = Color3.fromRGB(110, 118, 160),
            HoverChange = 0.07
        }
    end,
    [50] = function()
